...
public class StockParse {
    public static List<StockModel> parseurl(String url) throws Exception {
        ...
        for (int i = 0; i < stocklist.size(); i++) {
            ...
            long stock_trading_number=0;
            long stock_trading_value=0;
            ...
            if (!stocklist.get(i).split(",")[3].equals("-")) {
                ...
                stock_trading_number=Long.parseLong(stocklist.get(i).split(",")[7].replace("%", ""));
                stock_trading_value=Long.parseLong(stocklist.get(i).split(",")[8].replace("%", ""));
