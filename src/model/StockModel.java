 ...
 *stock_range;                 涨跌幅
 *stock_amplitude;             振幅
 *stock_trading_number;        成交量
 *stock_trading_value;         成交额（万）
 *stock_yesterdayfinish_price; 昨天收盘价
 *stock_todaystart_price;      今天开盘价
 *stock_max_price;             最高价
 *stock_min_price;             最低价
 *stock_fiveminuate_change;    五分钟内涨跌
 *craw_time;                   创建时间
 */
public class StockModel {
	    ...
	    private long stock_trading_number;
	    private long stock_trading_value;
	    ...
	    public long getStock_trading_number() {
	        return stock_trading_number;
	    }
	    public void setStock_trading_number(long stock_trading_number) {
	        this.stock_trading_number = stock_trading_number;
	    }
	    public long getStock_trading_value() {
	        return stock_trading_value;
	    }
	    public void setStock_trading_value(long stock_trading_value) {
