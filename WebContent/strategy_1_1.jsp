    ...
    <tr>
      <td><table width="1949px" border="0" >
          <tr>
            ...
            <td><div class="stra_title">
    <table width="1600" border="0">
  <tr>
    <th scope="col"><h3 style="color:#000">动量策略</h3></th>
...
look.onclick = function(e1) {
	...
	<%}%>
              ...
              <table width="100%" border="0">
                <tr>
                  <td colspan="2"><form action="strategy_1_1.spring" method="post"  class="strategy_form" name="toSubmit" onSubmit="return check();">
                      开始时间
                      <input class="Wdate" name="begin" type="text" onClick="WdatePicker()">
                      结束时间
                      <input class="Wdate" name="end" type="text" onClick="WdatePicker()">
                    <!--  </form></td>
                </tr>
                <tr>
                   <td><form action="strategy_1_1.spring" method="get" class="strategy_form"> -->
                      股票池选择
                      <select name="stockpool">
                        <option value="0">上证</option>
                        <option value="1">深证</option>
                        <option value="2">创业板</option>
                        <option value="3">自选股</option>
                      </select>
                      参数
                      <input class="textinput" name="chiyou" type="text" id="search_input" placeholder="持仓周期" autocomplete="off">
                      <input class="textinput" name="xingcheng" type="text" id="search_input" placeholder="形成期" autocomplete="off">
                      <input type="submit" class="button2" value="START" hidefocus="true" />
                    </form></td>
                </tr>
                <tr>
                  <td colspan="2"><div class="stock-info" data-spm="2">
                        ...
                        <div class="price">
                          <div class="bets-content">
                            <div class="line1">
                              <dl>
                                <dt>年化收益率</dt>
                                <dd><%=(s.getAttribute("annualreturn")==null)?"":String.valueOf(s.getAttribute("annualreturn")) %></dd>
                              </dl>
                              <dl>
                                <dt>基准年化收益率</dt>
                                <dd><%=(s.getAttribute("staAnnualreturn")==null)?"":String.valueOf(s.getAttribute("staAnnualreturn")) %></dd>
                              </dl>
                              <dl>
                                <dt>阿尔法系数</dt>
                                <dd ><%=(s.getAttribute("alpha")==null)?"":String.valueOf(s.getAttribute("alpha")) %></dd>
                              </dl>
                              <dl>
                                <dt>贝塔系数</dt>
                                <dd><%=(s.getAttribute("beta")==null)?"":String.valueOf(s.getAttribute("beta")) %></dd>
                              </dl>
                              <dl>
                                <dt>夏普比率</dt>
                                <dd><%=(s.getAttribute("sharp")==null)?"":String.valueOf(s.getAttribute("sharp")) %></dd>
                              </dl>
                              <dl>
                                <dt>最大回撤</dt>
                                <dd><%=(s.getAttribute("MaxDrawdown")==null)?"":String.valueOf(s.getAttribute("MaxDrawdown")) %></dd>
                              </dl>
                            </div>
                          </div>
                        </div>
                ...
                <tr>
                  <td colspan="2"><div id="Yield_comparison" style="height:400px"></div></td>
                </tr>
                <tr>
                  <td colspan="2"><div id="Yield_distribution" style="height:400px"></div></td>
                </tr>
              </table></td>
          </tr>
        </table></td>
...
function check(){
	...
	var shuliang=document.toSubmit.xingcheng.value;
	var end=document.toSubmit.end.value;
	var start=document.toSubmit.begin.value;
    ...
    else if(day/2<chiyou||day/2<shuliang){
    	alert("时间太短或周期太长");
        return false; 
    }
            ...
            function (ec) {
                ...
                var option = {
                    ...
                    xAxis : [
                        {
                            type : 'category',
                            data : ["-0.09以下","-0.09~-0.08","-0.08~-0.07","-0.07~-0.06","-0.06~-0.05","-0.05~-0.04","-0.04~-0.03","-0.03~-0,02","-0.02~-0.01","-0.01~0","0~0.01","0.01~0.02","0.02~0.03","0.03~0.04","0.04~0.05","0.05~0.06","0.06~0.07","0.07~0.08","0.08~0.09","0.09以上"],
                        }
                    ],
                    yAxis : [
                        {
