...
<table width="1950px" border="3" align="center" bgcolor="#FFFF99" id="comta">
  ...
  <tr>
    <th scope="col"><h3 style="color:#000">周期参考-动量策略</h3></th>
    <th scope="col"></th>
  </tr>
</table> 
...
look.onclick = function(e1) {
    ...
    <table width="100%" border="0">
      <tr>
        <td colspan="2"><form action="strategy_2_1.spring" method="post"  class="strategy_form" name="toSubmit" onSubmit="return check();">
            开始时间
