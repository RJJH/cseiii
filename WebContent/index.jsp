      ...
      <table width="1950px" border="0">
        <tr>
          <td><ul class="am-avg-sm-2 am-avg-md-3 am-avg-lg-6 am-thumbnails">
              ...
              <li class="am-animation-slide-top" data-am-scrollspy="{animation:'slide-top', delay: 0}"> <a href="allstock.html" target="_blank" id="suoyou"><img src="images/areabg2.png" width="180" height="90" /></a> </li>
            ...
            <ul class="am-avg-sm-2 am-avg-md-3 am-avg-lg-6 am-thumbnails">
              <li class="am-animation-slide-top am-animation-delay-1" data-am-scrollspy="{animation:'slide-top', delay: 100}"> <a href="longhu.jsp" target="_blank" id="longhubang"><img src="images/areabg5.png" width="180" height="90" /></a> </li>
              <li class="am-animation-slide-top am-animation-delay-1" data-am-scrollspy="{animation:'slide-top', delay: 100}"> <a href="Forecast.jsp" target="_blank" id="yuce"><img src="images/areabg6.png" width="180" height="90"  /></a> </li>
